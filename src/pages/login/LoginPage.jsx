...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (status && data.success) {
        const { access_token, token_type, role, user } = data;
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      ...
      <h1 className="text-3xl font-bold mb-6" style={{ fontFamily: 'Poppins, sans-serif', color: "#1e429f" }}>
    ...
    <img
      src={logo} // Ganti path ini sesuai lokasi gambar Anda
      alt="Logo"
      className="h-28 w-auto mr-10" // Sesuaikan ukuran gambar
    />
  </div>
